...
mockall::mock! {
    ...
    impl PostRepository for PostRepository {
        ...
        async fn list_by_thread(&self, thread_id: Uuid, page: u64, per_page: u64) -> Result<(Vec<Post>, u64), AppError>;
        ...
        async fn list_pending(&self, category_id: Option<Uuid>, page: u64, per_page: u64) -> Result<(Vec<Post>, u64), AppError>;
    }
}
