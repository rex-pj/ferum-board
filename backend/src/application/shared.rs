...
impl AppError {
    ...
    pub fn status_and_code(&self) -> (StatusCode, &str) {
        match self {
            ...
            AppError::UnprocessableEntity(_) => (StatusCode::UNPROCESSABLE_ENTITY, "validation_error"),
...
impl IntoResponse for AppError {
    fn into_response(self) -> Response {
        ...
        let retry_after = if let AppError::TooManyRequests(secs) = &self { Some(*secs) } else { None };
