...
use crate::application::usecases::post_usecase::CreatePostCmd;
use crate::middleware::AuthUser;
use crate::view_models::post::{
    CreatePostRequest, PostListQuery, PostResponse, UpdatePostRequest,
};
...
pub async fn create_post_handler(
    ...
    let post = state
        .post
        .create(actor, CreatePostCmd { thread_id, parent_id: body.parent_id, content_md: body.content_md })
        .await?;

    Ok((StatusCode::CREATED, Json(DataResponse::new(PostResponse::from(post)))))
}
