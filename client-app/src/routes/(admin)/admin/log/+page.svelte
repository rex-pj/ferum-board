<svelte:head>
	<title>Audit Log | Admin | {data.siteName ?? 'Ferum Board'}</title>
	...
	{:else}
		<div class="card-body p-0">
			<div class="fr-empty-state">
				<div class="fr-empty-icon"><i class="fa-solid fa-scroll"></i></div>
				<h2 class="fr-empty-title">No log entries</h2>
				<p class="fr-empty-sub">Admin and moderation actions will be recorded here.</p>
			</div>
		</div>
	{/if}
</div>
